        ...
        <div className="container">
            <nav className='nav'>
                ...
                <ul className='nav__list__icon'>
                    ...
                    <li className='nav__list__icon__items'><a href="#"><i className="bi bi-search"></i></a></li>
                    <li className='nav__list__icon__items'><a href="#"><i className="bi bi-cart"></i></a></li>
                    <li className='nav__list__icon__items'><a href="#"><i className="bi bi-person"></i></a></li>
                </ul>
                <ul className='nav__res' onClick={()=> setNav(!nav)}>
                    <li><a className='nav__res__a' href="#"><i class="bi bi-cart"></i></a></li>
                    {nav ? <li><button onClick={(e)=>console.log("ok2")} className='nav__res__btn2' ><i className="bi bi-x-lg"></i></button></li>: <li><button onClick={(e)=>console.log("ok1")} className='nav__res__btn1' ><i className="bi bi-text-right"></i></button></li>}
                </ul>
                <div className={nav ? ['nav__responsive', 'active'].join(' ') : ["nav__responsive"]}>
                    ...
                    <div className="nav__responsive__list">
                        ...
                        <ul className='nav__responsive__list__2'>
                            <li className='nav__responsive__list__2__items'><a href="#"><i className="bi bi-person"></i> My account</a></li>
                            <li className='nav__responsive__list__2__items'><a href="#"><i className="bi bi-box-arrow-right"></i> Logout</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
